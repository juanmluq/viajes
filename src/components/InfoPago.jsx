...
export default function InfoPago() {
  ...
  return (
    ...
    <div className='centradoInfo'>
        ...
        <br />
        <div>
          Una vez enviado el formulario y con la confirmacion de disponibilidad de fecha pueden abonar el 35% del valor total para reservar dicho fecha.
        <br />
        <br />
          Aceptamos transferencias a:
        <br />
        Cvu: 0000003100087283898980
        <br />
        Alias: tueventoresuelto.mp
        <br />
        <br />
      ...
      <br />
      <br />
      Una vez hecho el pago enviar comprobante por whatsapp al 1166635478
      <br />
      <div className='fondo'>       
