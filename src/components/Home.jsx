...
import './Home.css';
import imglog from "../img/logobordeesq.png"
...
export default function Home() {
  ...
  return (
    ...
    <div className='home'>
            ...
            <img className='imagens' src="https://i.pinimg.com/550x/10/95/36/10953636c1a4c3674c330b52a0cc1d84.jpg" alt="gif" />
        ...
        <div className='bienvenido'>
          <div className='subbienv' >
            ...
            <h8>seleccionando menu, fecha</h8>
            <h8>y cantidad de personas.</h8>
          </div>
          <div className='subbienv'>
            <h2>Reservá</h2>
            <h8>Con nuestra confirmacion</h8> 
            <h8>de disponibilidad podes</h8>
            <h8>realizar un deposito del 35%.</h8>
          </div>
          <div className='subbienv'>
           <h2>Disfrutá</h2>
...
</svg>Mail: tueventoresuelto1@gmail.com
